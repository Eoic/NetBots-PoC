...
export const dom = {
    ...
    robotNameValue: requiredEl<HTMLSpanElement>('robot-name-value'),
    ...
    newFileBtn: requiredEl<HTMLButtonElement>('btn-new-file'),
    newFolderBtn: requiredEl<HTMLButtonElement>('btn-new-folder'),
